$(function () {
	...
	$('tbody').on('click', '.btn', function () {
		...
		if (isDelete == 1) {
			console.log(1);
			$('#manage-modal').find('.alert').html('<i class="glyphicon glyphicon-question-sign"></i> 您确定要启用' + name + '吗？')
		} else {
			console.log(0);
			$('#manage-modal').find('.alert').html('<i class="glyphicon glyphicon-question-sign"></i> 您确定要禁用' + name + '吗？')
		}
